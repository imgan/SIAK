					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Nama Tarif </label>
								<div class="col-sm-9">
									<input type="text" id="ntarif" name="ntarif" placeholder="Nama tarif" class="form-control" />
								</div>
                            </div>
                            <div class="form-group">
